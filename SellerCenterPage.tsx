          ...
          <div className="flex-1 min-w-0">
            {tab === 'dashboard' && (
              <div className="animate-fade-up space-y-6">
                <h1 className="font-display text-2xl font-semibold text-[#0f172a]">{t.seller.dashboard}</h1>
                ...
                {/* Recent orders */}
                <div>
                  <h2 className="font-display text-lg font-semibold text-[#0f172a] mb-3">{t.seller.recentOrders}</h2>
            ...
            {tab === 'products' && (
              <div className="animate-fade-up">
                <div className="flex items-center justify-between mb-6">
                  <h1 className="font-display text-2xl font-semibold text-[#0f172a]">{t.seller.products}</h1>
            ...
            {tab === 'orders' && (
              <div className="animate-fade-up">
                <h1 className="font-display text-2xl font-semibold text-[#0f172a] mb-6">{t.seller.orders}</h1>
                {orders.length === 0 ? (
            ...
            {tab === 'analytics' && (
              <div className="animate-fade-up space-y-6">
                <h1 className="font-display text-2xl font-semibold text-[#0f172a]">{t.seller.analytics}</h1>
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            {tab === 'ads' && (
              <div className="animate-fade-up">
                <div className="flex items-center justify-between mb-6">
                  <h1 className="font-display text-2xl font-semibold text-[#0f172a]">{t.seller.ads}</h1>
            ...
            {tab === 'reputation' && (
              <div className="animate-fade-up space-y-6">
                <h1 className="font-display text-2xl font-semibold text-[#0f172a]">{t.seller.reputation}</h1>
            ...
            {tab === 'wallet' && (
              <div className="animate-fade-up space-y-6">
                <h1 className="font-display text-2xl font-semibold text-[#0f172a]">{locale === 'fr' ? 'Portefeuille' : 'Wallet'}</h1>
            ...
            {tab === 'messages' && (
              <div className="animate-fade-up">
                <h1 className="font-display text-2xl font-semibold text-[#0f172a] mb-6">{locale === 'fr' ? 'Messages' : 'Messages'}</h1>
            ...
            {tab === 'invoices' && (
              <div className="animate-fade-up">
                <h1 className="font-display text-2xl font-semibold text-[#0f172a] mb-6">{locale === 'fr' ? 'Factures' : 'Invoices'}</h1>
            ...
            {tab === 'returns' && (
              <div className="animate-fade-up">
                <h1 className="font-display text-2xl font-semibold text-[#0f172a] mb-6">{t.seller.returns}</h1>
            ...
            {tab === 'deliveries' && (
              <div className="animate-fade-up">
                <h1 className="font-display text-2xl font-semibold text-[#0f172a] mb-6">{t.seller.deliveries}</h1>
                <div className="grid sm:grid-cols-2 gap-4">
            ...
            {tab === 'settings' && (
              <div className="animate-fade-up space-y-6">
                <h1 className="font-display text-2xl font-semibold text-[#0f172a]">{locale === 'fr' ? 'Paramètres boutique' : 'Store settings'}</h1>
