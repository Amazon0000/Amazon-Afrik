    ...
    <div className="motif-bg min-h-screen">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
        <div className="flex items-center gap-4 mb-8">
          ...
          <div><h1 className="font-display text-2xl font-semibold text-[#0f172a]">{user.fullName}</h1><p className="text-sm text-[#64748b]">{user.email}</p></div>
        </div>
          ...
          <div className="flex-1 min-w-0">
            {tab === 'profile' && (
              <div className="card p-6 animate-fade-up">
                <h2 className="font-display text-lg font-semibold text-[#0f172a] mb-5">{t.account.personalInfo}</h2>
            ...
            {tab === 'orders' && (
              <div className="animate-fade-up">
                <h2 className="font-display text-lg font-semibold text-[#0f172a] mb-5">{t.account.orderHistory}</h2>
                {orders.length === 0 ? (
            ...
            {tab === 'addresses' && (
              <div className="animate-fade-up">
                <div className="flex items-center justify-between mb-5">
                  <h2 className="font-display text-lg font-semibold text-[#0f172a]">{t.account.myAddresses}</h2>
            ...
            {tab === 'wishlist' && (
              <div className="animate-fade-up">
                <h2 className="font-display text-lg font-semibold text-[#0f172a] mb-5">{t.account.wishlist}</h2>
