  ...
  return (
    <div className="motif-bg min-h-screen">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16">
        <h2 className="font-display text-3xl font-semibold text-[#0f172a] text-center mb-10">
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 py-16">
        <div className="text-center mb-10">
          <h2 className="font-display text-3xl font-semibold text-[#0f172a] mb-2">
      ...
      <section className="max-w-3xl mx-auto px-4 sm:px-6 py-16">
        <h2 className="font-display text-3xl font-semibold text-[#0f172a] text-center mb-10">FAQ</h2>
