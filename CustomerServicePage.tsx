    ...
    <div className="motif-bg min-h-screen">
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 py-10">
        <div className="space-y-8">
          {filtered.map((cat) => (
            <div key={cat.title}>
              <h2 className="font-display text-lg font-semibold text-[#0f172a] mb-3 flex items-center gap-2">
      ...
      {/* Contact methods */}
      <section className="max-w-5xl mx-auto px-4 sm:px-6 py-10">
        <h2 className="font-display text-xl font-semibold text-[#0f172a] mb-4">{locale === 'fr' ? 'Contactez-nous' : 'Contact us'}</h2>
