    ...
    return (
      <div className="motif-bg min-h-screen flex items-center justify-center px-4 py-12">
        <div className="card p-8 max-w-md text-center animate-fade-up">
          ...
          <h2 className="font-display text-2xl font-semibold text-[#0f172a] mb-2">{t.checkout.orderPlaced}</h2>
  ...
  return (
    <div className="motif-bg min-h-screen">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
        <h1 className="font-display text-3xl font-semibold text-[#0f172a] mb-6">{t.checkout.title}</h1>
        <div className="grid lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 space-y-6">
            {/* Address */}
            <div className="premium-card p-5 rounded-2xl">
              <h2 className="font-display text-lg font-semibold text-[#0f172a] mb-4 flex items-center gap-2"><MapPin className="w-5 h-5 text-[#0e9f6e]" /> {t.checkout.deliveryAddress}</h2>
              {user ? (
                <>
                  {addresses.length > 0 ? (
            ...
            {/* Payment */}
            <div className="premium-card p-5 rounded-2xl">
              <h2 className="font-display text-lg font-semibold text-[#0f172a] mb-4 flex items-center gap-2"><CreditCard className="w-5 h-5 text-[#0e9f6e]" /> {t.checkout.paymentMethod}</h2>
              <div className="space-y-2">
          ...
          <div>
            <div className="premium-card p-5 sticky top-20 rounded-2xl bg-gradient-to-br from-white to-[#f8fbfa]">
              ...
              <div className="space-y-3 mb-4">
                {items.map((i) => (
                  <div key={i.variation ? `${i.productId}-${i.variation}` : i.productId} className="flex items-center gap-3">
