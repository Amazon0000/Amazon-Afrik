...
export const isOfflineMode = !import.meta.env.VITE_SUPABASE_URL || url.includes('placeholder-project.supabase.co');

export const supabase = createClient(url, anonKey, {
  auth: { persistSession: !isOfflineMode, autoRefreshToken: !isOfflineMode },
});
