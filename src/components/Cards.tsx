  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col justify-between">
        <div>
          {/* Product Name */}
          <h3 className="text-[13px] font-normal text-[#0f1111] leading-[17px] line-clamp-2 hover:text-[#e47911] font-sans">
            {product.name}
          </h3>
        ...
        <div className="mt-2.5">
          <div className="flex items-baseline gap-1.5">
            <span className="text-lg font-black text-[#0f1111] font-sans">
              ${product.price}
            </span>
            {product.old_price && (
...
export function SellerCard({ seller }: { seller: Seller }) {
  ...
  return (
    ...
    >
      <div className="relative h-24 overflow-hidden bg-[#0a2240]">
        <img
        ...
        {seller.is_official && (
          <span className="absolute top-2 right-2 px-1.5 py-0.5 text-[9px] font-black rounded-sm bg-[#ff9900] text-black uppercase">
            Official
          </span>
        )}
      </div>
      ...
      <div className="p-4 -mt-10 relative">
        ...
        <h3 className="mt-2.5 font-bold text-sm text-[#0f1111] group-hover:text-[#e47911]">{seller.business_name}</h3>
