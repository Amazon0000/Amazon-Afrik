    ...
    <div className="fixed bottom-0 left-0 right-0 z-[100] animate-fade-up">
      <div className="max-w-4xl mx-auto m-4 p-5 rounded-2xl bg-[#0f172a] shadow-2xl border border-white/10">
        <div className="flex flex-col sm:flex-row items-start gap-4">
          <div className="w-10 h-10 rounded-xl bg-[#0e9f6e]/20 flex items-center justify-center shrink-0">
            <Cookie className="w-5 h-5 text-[#0e9f6e]" />
          </div>
          ...
          <div className="flex gap-2 w-full sm:w-auto shrink-0">
            ...
            <button onClick={accept} className="flex-1 sm:flex-none px-5 py-2.5 rounded-lg text-xs font-semibold bg-[#0e9f6e] text-[#0f172a] hover:bg-[#0e9f6e]/90 transition-colors">
