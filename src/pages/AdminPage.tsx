              ...
              <div className="animate-fade-up">
                ...
                <div className="space-y-3">
                  ...
                  {pendingProducts.length === 0 && (
                    <div className="card p-8 text-center bg-white"><PackageCheck className="w-10 h-10 text-[#0e9f6e]/30 mx-auto mb-3" /><p className="text-sm text-[#64748b]">{locale === 'fr' ? 'Aucun produit en attente d\u2019approbation.' : 'No products pending approval.'}</p></div>
                  )}
                </div>
              </div>
            )}
